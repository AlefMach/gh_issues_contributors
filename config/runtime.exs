...
#
#     PHX_SERVER=true bin/gh_issues_contributors start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :gh_issues_contributors, GhIssuesContributorsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :gh_issues_contributors, GhIssuesContributors.Mailer,
